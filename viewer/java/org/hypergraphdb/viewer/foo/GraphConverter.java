 ...
 * APIs which are not part of core HGViewer are finalized.
 ...
 *   is going away in the next HGViewer release (the one after 2.1).
 **/
...
//       node.setOffset(xPos + m_xOff, yPos + m_yOff);
   ...
   * effect on the underlying HGViewer network view.  Use the return value
   ...
   * in the underlying HGViewer network view.
   * <code>getMaxWidth()</code> of the return object is ...
   * All distances are preserved from to HGViewer graph to the return object.
   **/
   ...
   * <code>layout</code>, HGViewer's current network view topology
...
//          layout.getNodePosition(n, false) + myLayout.m_yOff);
   ...
   * reason why it's important to &quot;lock&quot; the HGViewer desktop
