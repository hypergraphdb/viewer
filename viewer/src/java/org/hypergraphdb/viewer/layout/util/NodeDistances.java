...
public class NodeDistances //implements MonitorableTask 
{
    ...
    protected HGVNetwork perspective;
     ...
     *
     * @param nodes_list  a <code>List</code> of <code>giny.model.FNode</code> objects for
     ...
     *                    reside
     */
    public NodeDistances(List nodes_list, int[][] distances, HGVNetwork perspective) {
     ...
     */
    public NodeDistances(List nodesList, HGVNetwork perspective, HashMap nodeIndexToMatrixIndexMap) {
    ...
    public String getTaskDescription() {
        return "Calculating FNode Distances";
    }//getTaskDescription
...
//        this.canceled = false;
//
//        FNode[] nodes = new FNode[nodesList.size()];
//
//        // TODO: REMOVE
...
//
//            from_node = (FNode) nodesList.get(i);
//            if (from_node == null) {
//                continue;
//            }
