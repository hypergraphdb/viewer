...
public class NodeDistances //implements MonitorableTask 
{
     ...
     *                    reside
     */
    public NodeDistances(List nodes_list, int[][] distances, FGraphPerspective perspective) {
     ...
     */
    public NodeDistances(List nodesList, FGraphPerspective perspective, HashMap nodeIndexToMatrixIndexMap) {
