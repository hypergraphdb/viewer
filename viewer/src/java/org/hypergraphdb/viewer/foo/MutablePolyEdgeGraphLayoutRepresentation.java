 ...
 **/
public abstract class MutablePolyEdgeGraphLayoutRepresentation
  ...
  implements MutablePolyEdgeGraphLayout
{
   ...
   **/
  public MutablePolyEdgeGraphLayoutRepresentation
    (int numNodes,
     ...
     double[][] edgeAnchorYPositions)
  {
    ...
    nodeXPositions = null; nodeYPositions = null; isMovableNode = null;
                                        ...
                                        boolean xPosition)
  {
    ...
    return (xPosition ? m_edgeAnchorXPositions[edgeIndex] :
            m_edgeAnchorYPositions[edgeIndex])[anchorIndex];
  }
  ...
  public void deleteAnchor(int edgeIndex, int anchorIndex)
  {
    ...
    if ((!isMovableNode(getEdgeNodeIndex(edgeIndex, true))) &&
      ...
      throw new UnsupportedOperationException
        ("specified edge's anchor points cannot change");
  ...
  public void createAnchor(int edgeIndex, int anchorIndex)
  {
    ...
    final double srcX, srcY, trgX, trgY;
    if (anchorIndex == 0) {
                                ...
                                double xPosition, double yPosition)
  {
    ...
    if ((!isMovableNode(getEdgeNodeIndex(edgeIndex, true))) &&
      ...
      throw new UnsupportedOperationException
        ("specified edge's anchor points cannot change");
    if (xPosition < 0.0d || xPosition > getMaxWidth() ||
        yPosition < 0.0d || yPosition > getMaxHeight())
      throw new IllegalArgumentException
        ("trying to set anchor position outside of allowable rectangle");
