 ...
 * @author Slava Pestov
 * @version $Id: JARClassLoader.java,v 1.2 2006/02/03 18:24:16 bizi Exp $
 */
public class JARClassLoader extends ClassLoader
{
		...
		throws ClassNotFoundException
	{
		...
		try
		{
			 ...
			 * Echidna, etc) */
			ClassLoader parentLoader = AppConfig.getInstance().getClassLoader();//getClass().getClassLoader();
	 ...
	 * @since jEdit 4.2pre1
	 */
	JARClassLoader(/*PluginJAR*/ Object jar)
	{
		this();
		this.jar = jar;
	} //}}}
