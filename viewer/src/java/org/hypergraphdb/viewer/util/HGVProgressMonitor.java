...
//---------------------------------------------------------------------------------------
/**
 * HGVProgressMonitor. A progress monitor for org.hypergraphdb.viewer. It is recommended 
 ...
 */
public class HGVProgressMonitor extends JFrame
  implements Runnable{
   ...
   */
  public HGVProgressMonitor(MonitoredTask monitored_task){
