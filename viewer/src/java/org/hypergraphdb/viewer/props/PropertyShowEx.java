 ...
 * @version  0.16
 */
class PropertyShowEx extends javax.swing.JPanel {
     ...
     */
    public PropertyShowEx(PropertyEditor aPropertyEditor) {
    ...
    public void addSheetButtonListener (SheetButtonListenerEx sheetListener) {
        listeners.addElement (sheetListener);
    }

    /** Removes <code>SheetButtonListener</code>. */
    public void removeSheetButtonListener (SheetButtonListenerEx sheetListener) {
