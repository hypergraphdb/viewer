 ...
 * @author   Jan Jancura
 */
class SheetButtonEx extends JPanel {
    ...
    private Color foreground = Color.green; //SystemColor.controlText;
     ...
     */
    public SheetButtonEx(String aLabel) {
     ...
     */
    public SheetButtonEx(String aLabel, boolean isPlasticButton) {
     ...
     */
    public SheetButtonEx(String aLabel, boolean isPlasticButton, boolean plasticActionNotify) {
    ...
    private Image getInvalidImage() {
        return null;//Utilities.loadImage("org/openide/resources/propertysheet/invalid.gif"); //NOI18N
    }
     ...
     */
    void addSheetButtonListener (SheetButtonListenerEx sheetButtonListener) {
     ...
     */
    void removeSheetButtonListener (SheetButtonListenerEx sheetButtonListener) {
    ...
    public void notifySheetButtonListenersAboutClick (ActionEvent e) {
        ...
        int i, k = l.size ();
        for (i = 0; i < k; i++)
            ((SheetButtonListenerEx) l.elementAt (i)).sheetButtonClicked (e);
    }
    ...
    public void notifySheetButtonListenersAboutEntered (ActionEvent e) {
        ...
        int i, k = l.size ();
        for (i = 0; i < k; i++)
            ((SheetButtonListenerEx) l.elementAt (i)).sheetButtonEntered (e);
    }
    ...
    public void notifySheetButtonListenersAboutExited (ActionEvent e) {
        ...
        int i, k = l.size ();
        for (i = 0; i < k; i++)
            ((SheetButtonListenerEx) l.elementAt (i)).sheetButtonExited (e);
    }
	...
	IL() {}
        ...
        public void mouseDragged (MouseEvent e) {
            if(new Rectangle(SheetButtonEx.this.getSize())
        ...
        public void keyPressed (KeyEvent e) {
            ...
            if(e.getKeyCode () == KeyEvent.VK_DOWN) {
                ...
                fm.focusNextComponent(SheetButtonEx.this);
                e.consume();
            } else {
                if(e.getKeyCode () == KeyEvent.VK_UP) {
                    FocusManager fm = FocusManager.getCurrentManager ();
                    fm.focusPreviousComponent(SheetButtonEx.this);
                    e.consume();
                }
            }
        }
        ...
        public void focusGained (FocusEvent fe) {
            ...
            Component c = SheetButtonEx.this;
            Rectangle r = SheetButtonEx.this.getBounds();
