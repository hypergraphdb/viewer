...
public class SpringEmbeddedLayout implements Layout
{
    ...
    protected HashMap<PNodeView, Integer> nodeIndexToMatrixIndexMap; // maps a
                                                                     // root
                                                                     // graph
                                                                     // index to
                                                                     // a
                                                                     ...
                                                                     // matrix
                                                                     // index
    protected TreeMap<Integer, PNodeView> matrixIndexToNodeIndexMap; // maps a
                                                                     // distance
                                                                     // matrix
                                                                     // index to
                                                                     // a root
    ...
    public void doLayout()
    {
        ...
        for (layoutPass = 0; layoutPass < numLayoutPasses; layoutPass++)
        {
            ...
            // the furthest node towards where it wants to be.
    ...
    protected void setupNodeDistanceSprings()
    {
        ...
        Collection<PNodeView> matrixIndices = matrixIndexToNodeIndexMap
                .values();
        int i = 0;
        for (Iterator<PNodeView> iterator = matrixIndices.iterator(); iterator
                .hasNext();)
        {
        ...
        NodeDistances ind = new NodeDistances(nodeList, view,
                nodeIndexToMatrixIndexMap);
        ...
        System.out.println("node_distances: " + nodeDistanceSpringRestLengths
                + ":" + node_distances);
        ...
        for (int ii = 0; ii < nodeCount; ii++)
        {
            for (int jj = (ii + 1); jj < nodeCount; jj++)
            {
                ...
                // System.out.println( "node_distances1: " +
                ...
                else
                {
                    ...
                    // System.out.println(
                    // " ELSE 1: "+nodeDistanceSpringRestLengths[ node_i ][
                    // node_j ] );
                }
            ...
            boolean reversed)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            other_node_view_index = nodeIndexToMatrixIndexMap
                    .get(other_node_view);
