...
/**
 * <b>PSmallBoundsHandle</b> a handle for resizing the bounds of another node. If a
...
public class PSmallBoundsHandle extends PSmallHandle {
	...
	public static void addBoundsHandlesTo(PNode aNode) {
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createEastLocator(aNode))); 
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createWestLocator(aNode))); 
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createNorthLocator(aNode))); 
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createSouthLocator(aNode)));
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createNorthEastLocator(aNode))); 
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createNorthWestLocator(aNode))); 
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createSouthEastLocator(aNode))); 
		aNode.addChild(new PSmallBoundsHandle(PBoundsLocator.createSouthWestLocator(aNode))); 	
	}
  ...
  public static void addBoundsHandlesTo(PNode aNode, boolean only_quadrants ) {
	...
	public static void addStickyBoundsHandlesTo(PNode aNode, PCamera camera) {
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createEastLocator(aNode)));
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createWestLocator(aNode)));
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createNorthLocator(aNode)));
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createSouthLocator(aNode)));
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createNorthEastLocator(aNode)));
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createNorthWestLocator(aNode)));
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createSouthEastLocator(aNode)));
		camera.addChild(new PSmallBoundsHandle(PBoundsLocator.createSouthWestLocator(aNode)));
	}
	...
	protected void installHandleEventHandlers() {
		...
		handleCursorHandler = new PBasicInputEventHandler() {
			...
			public void mouseExited(PInputEvent aEvent) {
				...
				if (cursorPushed) {
					if (focus == null || focus.getPickedNode() != PSmallBoundsHandle.this) {
						aEvent.popCursor();
						cursorPushed = false;
					}
				}
    ...
    //( (PNodeView)n).setOffset( b.getX(), b.getY() );
    //( (PNodeView)n).setWidth( b.getWidth() );
    //( (PNodeView)n).setHeight( b.getHeight() );
